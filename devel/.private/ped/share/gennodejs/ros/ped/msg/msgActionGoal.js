...
let msgGoal = require('./msgGoal.js');
...
class msgActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = msgGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += msgGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msgActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = msgGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new msgGoal()
    }
