...
let msgFeedback = require('./msgFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class msgActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = msgFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new msgActionFeedback(null);
    ...
    data.feedback = msgFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += msgFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new msgActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = msgFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new msgFeedback()
    }
...
module.exports = msgActionFeedback;
