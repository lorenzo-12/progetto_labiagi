...
"""autogenerated by genpy from ped/msgActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class msgActionFeedback(genpy.Message):
  _md5sum = "99eff65d7d7ea548572edff08e1d4324"
  _type = "ped/msgActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','ped/msgFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(msgActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = ped.msg.msgFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = ped.msg.msgFeedback()
